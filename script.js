...
console.log(
  `Answer for first problem is :>>>> \n\nTest data 1 : i/p [5, 3, 9, 2, 7] o/p is --> ${reorderOddEven(
    [5, 3, 9, 2, 7]
  )}\n\nTest data 2 : i/p [10, -5, 0, 15, 20] o/p is --> ${reorderOddEven([
    10, -5, 0, 15, 20,
  ])}`
);
...
console.log(`Answer for third problem is :>>>> \n\n
...
console.log(`Answer for fourth problem is :>>>> \n\n
...
console.log(`Answer for fifth problem is :>>>> \n\n
Test data 1 : i/p "I love programming" o/p is --> ${longestWord(
  "I love programming"
)}\n\nTest data 2 : i/p "JavaScript is awesome" o/p is --> ${longestWord(
...
console.log(`Answer for seventh problem is :>>>> \n\n
...
console.log(`Answer for eighth problem is :>>>> \n\n
Test data 1 : i/p [2, 7, 11, 15] , 9 o/p is --> ${twoSum(
  [2, 7, 11, 15],
  9
)}\n\nTest data 2 : i/p [3, 2, 4], 6 o/p is --> ${twoSum([3, 2, 4], 6)}`);
...
console.log(`Answer for 9th problem is :>>>> \n\n
Test data 1 : i/p "abc" o/p is --> ${allCombinations(
  "abc"
)}\n\nTest data 2 : i/p "dog" o/p is --> ${allCombinations("dog")}`);
...
console.log(`Answer for 10th problem is :>>>> \n\n
